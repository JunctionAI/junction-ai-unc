  ...
  return (
    <>
      ...
      <div style={{ marginTop: 28 }}>
        ...
        {accounts && routineId === "D03-W01" && V.accountId && <SeoPackagePanel key={`seo:${V.accountId}:${V.contextGeneration}`} accountId={V.accountId} contextGeneration={V.contextGeneration}/>}

...
/* Landing page — pixel port of design-reference/Junction Landing.dc.html.
   ...
   Waitlist mode (2026-09-02): every CTA is a waitlist action — the hero CTA row and the navy
   closer's button are the inline email capture (WaitlistForm); the nav and pricing buttons
   scroll to one of them. `pricing` is the visitor's resolved locale row (src/lib/locale) —
   it drives the pricing card and the optional copy overrides; nothing else moves. */
...
export default function Landing({ pricing }: { pricing: LocalePricing }) {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 22, fontSize: 13.5, fontWeight: 500 }}>
          <button className="btn-navy" style={{ padding: "10px 20px", fontSize: 13 }} onClick={() => goToWaitlist("waitlist-hero")}>
            Join the waitlist
          </button>
        </div>
      </nav>
      ...
      >
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {pricing.copy?.heroSubline ?? "To get started, set a goal, and get to work together."}
          </p>
          <div style={{ marginTop: 30 }}>
            <WaitlistForm id="waitlist-hero" source="hero" helper={pricing.copy?.waitlistHelper} />
          </div>
      ...
      >
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 40px 80px" }}>
          ...
          <h3 style={{ fontSize: 22, fontWeight: 600, letterSpacing: "-0.015em", margin: "10px 0 0" }}>
            37 routines across five channels — one example each, the rest waiting inside.
          </h3>
      ...
      <section id="pricing" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div style={label}>{pricing.copy?.pricingLabel ?? "Pricing — simple, like the rest"}</div>
          <div style={{ display: "flex", alignItems: "baseline", justifyContent: "center", gap: 6, marginTop: 16 }}>
            <span style={{ fontSize: 54, fontWeight: 700, letterSpacing: "-0.03em" }}>{pricing.display}</span>
            <span style={{ fontSize: 15, color: "var(--muted)" }}>{pricing.suffix}</span>
          </div>
          <div
            style={{
              display: "inline-block",
          ...
          <button className="btn-navy" style={{ marginTop: 28, padding: "13px 32px", fontSize: 14.5 }} onClick={() => goToWaitlist("waitlist-closer")}>
            Join the waitlist →
          </button>
      ...
      <section style={{ background: "var(--navy)", color: "var(--on-navy)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "88px 40px", textAlign: "center" }}>
          ...
          <div style={{ marginTop: 30, display: "flex", justifyContent: "center" }}>
            <WaitlistForm id="waitlist-closer" source="closer" tone="navy" align="center" helper={pricing.copy?.waitlistHelper} />
          </div>
        </div>
      </section>
      <SiteFooter />

...
**Current override — 6 September NZ, Batch 44:** [actual US/NZ/AU operator round trips pass](integration/KEYWORD-LIVE-PILOT-2026-09-06.md), executions #77–79 at independently verified revision `92135add-3c35-43e4-9649-5bb3d4557814`. Account-specific registration, worker execution reader, authority, original-run persistence and dashboard/history readback are proven. Three real artifacts/15 receipts exist. Customer-triggered dispatch and recommendation quality remain partial; AVGAR is paused again, switches and external actions remain off. Earlier “source-only / no registration / API access missing” paragraphs below are historical, not current blockers.

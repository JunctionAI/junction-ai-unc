...
createRoot(document.getElementById('root')!).render(window.location.pathname==='/agents'?<><p>LOCAL UI TEST — simulated settings, no Grok or client calls</p><AgentsView accountId={account} contextGeneration={1} onInspect={()=>{}}/></>:window.location.pathname==='/inbox'?<AccountScopeProvider accountId={account} choices={[]}><div style={{padding:24,maxWidth:960,margin:'auto',fontFamily:'Arial,sans-serif'}}><p>LOCAL TEST — synthetic fixtures, not client work</p><ReviewInbox accountId={account} generation={1}/></div></AccountScopeProvider>:<ReviewWorkspace accountId={account} generation={1} outputId="00000000-0000-4000-8000-000000000004"/>);
